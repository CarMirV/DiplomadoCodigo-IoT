 ...
 * mediante MQTT
 * Autor: Carlos Daniel Miranda Viloria
 * Basado en el codigo de Hugo Escalpelo
 * https://github.com/codigo-iot/ESP32CAM_MQTT-Basic/blob/main/ESP32CAM_MQTT-Basic/ESP32CAM_MQTT-Basic.ino
 *
 * El programa se encargara de mandar los datos de temperatura de un
 * servidor mediante un brocker de mensajes.
 * MAPEO DE PINES:
...
//Datos de WiFiE
const char* ssid = "INFINITUMEE8E9_2.4";  // Aquí debes poner el nombre de tu red
const char* password = "2300538558";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "5.196.95.208"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    Serial.print(temp);
    client.publish("cmirServTemp",temp);
  }
}
